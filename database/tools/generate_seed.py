...
def main():
    ...
    out_lines = [
        ...
        "-- Prefer dataprep/ef-catalog/generated/ for canonical scope categories + versioned fuels.",
        "-- Run order (legacy helper): 01_schema.sql -> 02_seed_master_data.sql -> this file",
        "",
        "-- ===========================================",
