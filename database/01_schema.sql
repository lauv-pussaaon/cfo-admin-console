...
-- Version snapshots of active fuel_resources (same fuel UUIDs; restore upserts live rows)
CREATE TABLE ef_catalog_version_backups (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE TABLE ef_catalog_version_backup_fuels (
...
CREATE INDEX idx_ef_catalog_version_backups_source_version
  ON ef_catalog_version_backups (source_version);
CREATE INDEX idx_ef_catalog_version_backups_created_at
